...
export interface IItemTokenInterface extends utils.Interface {
  contractName: "IItemToken";
  functions: {
...
export interface IItemToken extends BaseContract {
  contractName: "IItemToken";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IItemTokenInterface;
